    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <form onSubmit={handleCreate} className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm space-y-6">
        <div className="space-y-4">
          <h3 className="font-extrabold text-sm text-slate-800 border-b pb-2">1. Task Details</h3>
          <div>
        ...
        <div className="space-y-4 pt-4 border-t">
          <h3 className="font-extrabold text-sm text-slate-800 border-b pb-2">2. Customer Contact Information</h3>
        ...
        <div className="space-y-4 pt-4 border-t">
          <div className="flex items-center justify-between border-b pb-2">
            <h3 className="font-extrabold text-sm text-slate-800">3. Task Site Location</h3>
            <button
              type="button"
              onClick={() => setIsLocationModalOpen(true)}
              className="px-3 py-1 bg-sky-50 text-sky-600 border border-sky-200 rounded-lg text-xs font-bold flex items-center gap-1.5 hover:bg-sky-100"
            >
        ...
        <div className="space-y-4 pt-4 border-t">
          <h3 className="font-extrabold text-sm text-slate-800 border-b pb-2">4. Priority & Engineer Assignment</h3>
        ...
        <button
          type="submit"
          disabled={submitting}
          className="w-full py-3.5 bg-sky-600 hover:bg-sky-500 disabled:opacity-50 text-white font-extrabold text-xs rounded-xl shadow-lg shadow-sky-600/30 transition-all flex items-center justify-center gap-2"
        >
